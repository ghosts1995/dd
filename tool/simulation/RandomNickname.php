...
class RandomNickname
{
    ...
    public function get()
    {
        $headNum = rand(0, 331);
        $tailNum = rand(0, 325);
        $nickname = $this->headData[$headNum] . $this->tailData[$tailNum];
        return $nickname;
    }
